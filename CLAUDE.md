...
- **Plugin-created properties** land in `plugin.property.logseq-timeline-plugin/*` but are schema-identical to user-created ones; discovery accepts both namespaces.
